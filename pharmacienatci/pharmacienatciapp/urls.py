...
urlpatterns = [
    ...
    # Prevision
    path('previsions/', views.api_prevision_liste),
    path('previsions/ajouter/', views.api_prevision_ajout),
    path('previsions/<str:pk>/', views.api_prevision_lecture),
    path('previsions/<str:pk>/modifier/', views.api_prevision_modifier),
    path('previsions/<str:pk>/supprimer/', views.api_prevision_supprimer),
    ...
    path('previsions/ia/actualiser/', views.api_prevision_ia_actualiser),

    # IA Dashboards
    path('ia/dashboard/etablissement/<str:pk>/', views.api_ia_dashboard_etablissement),
    path('ia/dashboard/region/<str:pk>/', views.api_ia_dashboard_region),
]
if settings.DEBUG:
